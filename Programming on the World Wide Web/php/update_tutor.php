...
if ($department) {
    $updateDeptQuery = "INSERT INTO profs (prof_id, department) VALUES ($user_id, '$department') ON DUPLICATE KEY UPDATE department = '$department'";
    $resultDept = mysqli_query($link, $updateDeptQuery);
}

// Insert or update the specialization
if ($specialization) {
    $updateSpecQuery = "INSERT INTO profs (prof_id, specialization) VALUES ($user_id, '$specialization') 
