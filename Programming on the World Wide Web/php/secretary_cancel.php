...
if ($thesis_id > 0) {
    $sql1 = "UPDATE theses SET student_id = NULL, status= NULL, supervisor2_id = NULL, supervisor3_id = NULL, assigned_at = NULL, protocol_number = NULL WHERE thesis_id = $thesis_id";
    $result1 = mysqli_query($link, $sql1);

    $sql2 = "DELETE FROM assigned_theses WHERE thesis_id = $thesis_id";
    $result2 = mysqli_query($link, $sql2);

    $sql3 = "INSERT INTO cancelled_theses (thesis_id, cancel_date, reason, cancelled_by, assembly_number) VALUES ($thesis_id, $assembly_year, '$reason', $user_id, '$assembly_number')";
