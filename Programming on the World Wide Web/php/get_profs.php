...
$sql = "SELECT u.user_id, u.name, u.surname, t.department FROM users u INNER JOIN profs t ON u.user_id = t.prof_id 
        LEFT JOIN theses th ON u.user_id = th.supervisor_id AND th.thesis_id = $thesis_id WHERE th.thesis_id IS NULL";

$sql2 = "SELECT thesis_id, supervisor2_id, supervisor3_id FROM assigned_theses";
...
if ($result && $result2) {
    echo json_encode(['success' => true, 'profs' => $profs, 'theses' => $theses]);
} else {
