...
$sql = "SELECT 
            ...
            u2.name AS supervisor2_name, u2.surname AS supervisor2_surname,
            u3.name AS supervisor3_name, u3.surname AS supervisor3_surname
        FROM theses t
        LEFT JOIN users u1 ON u1.user_id = t.supervisor_id
        LEFT JOIN users u2 ON u2.user_id = t.supervisor2_id
        LEFT JOIN users u3 ON u3.user_id = t.supervisor3_id
