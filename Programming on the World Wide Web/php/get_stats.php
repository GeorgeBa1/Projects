...
if ($user_id > 0) {
    ...
    // Fetch average grades where the user is a supervisor1
    ...
    $query_committee = "
        ...
        FROM theses th
        WHERE (th.supervisor2_id = $user_id OR th.supervisor3_id = $user_id) 
    ...
    $query_committee_grades = "
        SELECT 
            AVG(r.supervisor2_grade) AS avg_grade_co1,
            AVG(r.supervisor3_grade) AS avg_grade_co2
        FROM grades r
        INNER JOIN theses th ON r.thesis_id = th.thesis_id
        WHERE (th.supervisor2_id = $user_id OR th.supervisor3_id = $user_id)
