...
$query = "SELECT supervisor_id, supervisor2_id, supervisor3_id FROM theses WHERE thesis_id = $thesis_id";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    } elseif ($user_id == $thesis['supervisor2_id']) {
        $grade_field = 'supervisor2_grade';
        $detailed_field = 'detailed_grade2';
    } elseif ($user_id == $thesis['supervisor3_id']) {
        $grade_field = 'supervisor3_grade';
    ...
    $check_query = "SELECT * FROM grades WHERE thesis_id = $thesis_id";
    ...
    if ($check_result && mysqli_num_rows($check_result) > 0) {
        ...
        $insert_query = "INSERT INTO grades (thesis_id, $grade_field, $detailed_field) 
